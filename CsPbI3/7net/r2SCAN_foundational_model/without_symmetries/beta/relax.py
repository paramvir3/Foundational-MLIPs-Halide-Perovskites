...
from ase.optimize import BFGS, LBFGS, FIRE, MDMin, GPMin
...
def opt_with_symmetry(
    ...
    opt.run(fmax=1e-04, steps=100000) 
...
unit_atoms=read("beta.cif")
crystal_atoms = unit_atoms.repeat((1,2,2))
...
checkpoint_path = "/mnt/scratch2/q13camb_scratch/perovskites/CsPbI3_relaxed_structures/7net/CsPbI3_relative_energies/r2SCAN_foundational_models/without_symmetries/checkpoint_sevennet_mf_0_r2SCAN.pth"
